...
namespace RML
{
	TEST(RML_Matrix, construct_blank_matrix_4x4)
	{
	...
	TEST(RML_Matrix, construct_matrix_4x4)
	{
		Matrix<float, 4, 4> matrix({
			1, 2, 3, 4,
			5.5, 6.5, 7.5, 8.5,
	...
	TEST(RML_Matrix, construct_matrix_2x2)
	{
	...
	TEST(RML_Matrix, construct_matrix_3x3)
	{
	...
	TEST(RML_Matrix, construct_matrix_2x5)
	{
	...
	TEST(RML_Matrix, construct_matrix_5x2)
	{
	...
	TEST(RML_Matrix, matrix_equality_with_identical_matrices_as_ints)
	{
		Matrix<int, 4, 4> a({
			1,2,3,4,
			5,6,7,8,
	...
	TEST(RML_Matrix, matrix_equality_with_different_matrices_as_ints)
	{
		Matrix<int, 4, 4> a({
			1, 2, 3, 4,
			5, 6, 7, 8,
	...
	TEST(RML_Matrix, matrix_equality_with_identical_matrices_as_floats)
	{
		Matrix<float, 4, 4> a({
			1.5, 2.5, 3.5, 4.5,
			5.5, 6.5, 7.5, 8.5,
	...
	TEST(RML_Matrix, matrix_equality_with_different_matrices_as_floats)
	{
		Matrix<float, 4, 4> a({
			1.5, 2.5, 3.5, 4.5,
			5.5, 6.5, 7.5, 8.5,
	...
	TEST(RML_Matrix, matrix_multiplication_4x4)
	{
		Matrix<float, 4, 4> a({
			1, 2, 3, 4,
			5, 6, 7, 8,
	...
	TEST(RML_Matrix, matrix_multiplication_3x2_2x4)
	{
		Matrix<float, 3, 2> a({
			1, 3,
			2, 4,
	...
	TEST(RML_Matrix, matrix_multiplication_is_non_commutative)
	{
		Matrix<float, 4, 4> a({
			1, 2, 3, 4,
			5, 6, 7, 8,
	...
	TEST(RML_Matrix, matrix_multiplication_with_tuple)
	{
		Matrix<float, 4, 4> matrix({
			1, 2, 3, 4,
			2, 4, 4, 2,
	...
	TEST(RML_Matrix, matrix_multiplication_undefined)
	{
		Matrix<float, 2, 5> a;
	...
	TEST(RML_Matrix, identity_matrix_3x3)
	{
		Matrix<float, 3, 3> matrix({
			1, 2, 3,
			4, 5, 6,
	...
	TEST(RML_Matrix, identity_matrix_4x4)
	{
		Matrix<float, 4, 4> matrix({
			1, 2, 3, 4,
			2, 4, 4, 2,
	...
	TEST(RML_Matrix, matrix_transpose_4x4)
	{
		Matrix<float, 4, 4> matrix({
			0, 9, 3, 0,
			9, 8, 0, 8,
	...
	TEST(RML_Matrix, matrix_transpose_2x4)
	{
	...
	TEST(RML_Matrix, matrix_transpose_identity)
	{
		auto identity = Matrix<float, 4, 4>::identity();
	...
	TEST(RML_Matrix, matrix_determinant_non_square)
	{
	...
	TEST(RML_Matrix, matrix_determinant_1x1)
	{
	...
	TEST(RML_Matrix, matrix_determinant_2x2)
	{
		Matrix<float, 2, 2> matrix({
			1, 5,
			-3, 2
	...
	TEST(RML_Matrix, matrix_determinant_3x3)
	{
		Matrix<float, 3, 3> matrix({
			1, 2, 6,
			-5, 8, -4,
	...
	TEST(RML_Matrix, matrix_determinant_4x4)
	{
		Matrix<float, 4, 4> matrix({
			-2, -8, 3, 5,
			-3, 1, 7, 3,
	...
	TEST(RML_Matrix, submatrix_of_3x3_is_2x2)
	{
		Matrix<float, 3, 3> matrix({
			1, 5, 0,
			-3, 2, 7,
	...
	TEST(RML_Matrix, submatrix_of_4x4_is_3x3)
	{
		Matrix<float, 4, 4> matrix({
			-6, 1, 1, 6,
			-8, 5, 8, 6,
	...
	TEST(RML_Matrix, submatrix_of_1x1_throws_exception)
	{
	...
	TEST(RML_Matrix, minor_of_a_3x3_matrix)
	{
		Matrix<float, 3, 3> matrix({
			3, 5, 0,
			2, -1, -7,
	...
	TEST(RML_Matrix, cofactor_of_a_3x3_matrix)
	{
		Matrix<float, 3, 3> matrix({
			3, 5, 0,
			2, -1, -7,
	...
	TEST(RML_Matrix, matrix_is_invertible)
	{
		Matrix<float, 4, 4> matrix({
			6, 4, 4, 4,
			5, 5, 7, 6,
	...
	TEST(RML_Matrix, matrix_is_not_invertible)
	{
		Matrix<float, 4, 4> matrix({
			-4, 2, -2, -3,
			9, 6, 2, 6,
	...
	TEST(RML_Matrix, matrix_inversion_1)
	{
		Matrix<float, 4, 4> a({
			-5, 2, 6, -8,
			1, -5, 1, 8,
	...
	TEST(RML_Matrix, matrix_inversion_2)
	{
		Matrix<float, 4, 4> matrix({
			8, -5, 9, 2,
			7, 5, 6, 1,
	...
	TEST(RML_Matrix, matrix_inversion_3)
	{
		Matrix<float, 4, 4> matrix({
			9, 3, 0, 9,
			-5, -2, -6, -3,
	...
	TEST(RML_Matrix, matrix_multiply_by_inverse)
	{
		Matrix<float, 4, 4> a({
			3, -9, 7, 3,
			3, -8, 2, -9,
